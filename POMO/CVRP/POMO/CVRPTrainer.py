...
from CVRP.POMO.CVRPModel import CVRPModel as Model
from CVRPLocalSearch import CVRPLocalSearch as LocalSearch
...
class CVRPTrainer:
    ...
    def _train_one_batch(self, batch_size):
        ...
        route_len = torch.zeros(size=(batch_size, self.env.pomo_size))        
        ...
        while not done:
            ...
            route_len = torch.where(selected != 0, state.selected_count, route_len)
        # Loss
        ###############################################
